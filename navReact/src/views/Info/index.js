...
import Background from "../../static/img/bg2.png"
...
class Energy extends Component{
    jump=(val)=>{
       window.location.href='http://hzemis.hzzhny.com/'+val
    }
    render(){
        return(
            ...
            <Col span={12}  className="container-item">
                <div className="container-items">
                    ...
                    <ul className="navList">
                        <li onClick={()=>this.jump(2)}><span className="text-item">用能单位报送入口</span> <CaretRightOutlined /></li>
                        <li onClick={()=>this.jump(3)}><span className="text-item">报表管理入口</span> <CaretRightOutlined /></li>
                    </ul>
                </div>
            </Col>
          </Row>)
