        ...
        <el-row>
          ...
          <el-col :span="4">
            <el-form-item label="信审人员">
              <el-select v-model="jsondata.examineRepeatId" placeholder="信审人员">
                <el-option
        ...
        <el-row>
          ...
          <el-col :span="4">
            <el-form-item label="分配状态">
              <el-select v-model="jsondata.isExamineRepeatIssue" placeholder="分配状态">
                <el-option
...
export default {
  ...
  data() {
    return {
      ...
      jsondata: {
        ...
        examineStatus: '2', // 审批状态
        examineRepeatId: '', // 复审的信审人员
        isExamineRepeatIssue: null,
        page: 1, // 当前页
        pageSize: 10, // 每页20条数据
        type: 'REPEAT'
      },
  ...
  mounted() {
    this.getList()// 获取列表
    this.getExamineAdmin() // 获取信审管理员
    this.getExamineStatus() // 获取复审  状态
    this.getIssue()// 获取分配状态
  },
  methods: {
    ...
    // 获取  信审人员
    getExamineStatus() {
      getExamineStatus({ type: 'REPEAT' }).then(r => {
    ...
    Search() {
      this.jsondata.page = 1 // 当前页
      this.jsondata.pageSize = 10 // 每页10条数据
      this.getList()
    }
  }
}
